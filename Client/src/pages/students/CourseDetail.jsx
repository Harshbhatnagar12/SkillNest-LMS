...
const CourseDetail = () => {
  ...
  return courseData ? (
   ...
   <div className='absolute top-0 left-0 w-full h-section-height -z-10 bg-linear-to-b from-cyan-100/70 to-white'>
</div>
      ...
      <p className='pt-4 md:text-base text-sm ' dangerouslySetInnerHTML={{__html: courseData.courseDescription.slice(0,200)}} ></p>
         ...
         {/* Review and Ratings  */}
          <div className='flex items-center space-x-2 pt-3 pb-1 text-sm  '>
                 ...
                 <p className='text-sm '>Course by <span className='text-blue-600 undeline '>Harsh Bhatnagar</span></p>
          ...
          <div className='p-5 '>
           ...
           <div className='pt-6 '>
            ...
            <ul className='ml-4 pt-2 text-sm md:text-default list-disc text-gray-500'>
              ...
              <li>Step-ny-step, hands-on project guidance. </li>
